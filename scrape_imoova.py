    ...
    for row in rows_data:
        ...
        try:
            ...
            deal = ImoovaDeal(
                ...
                drive_days=drive_days if drive_days > 0 else (deliver_date - depart_date).days,
                vehicle=vehicle,
                rate_raw=rate_raw,
                rate_gbp=parse_rate_to_gbp(rate_raw, drive_days if drive_days > 0 else (deliver_date - depart_date).days),
